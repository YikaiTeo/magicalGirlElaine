...
class city extends Phaser.Scene {
  ...
  create() {
    ...
    //player//
    var elaineScale = 0.2;
    this.player = this.physics.add.sprite(2400, 2000, "elaine").setScale(elaineScale).setSize(250, 370);
    //
    //NPCs//
    var npcSizeX = 200;
    var npcSizeY = 500;
    ...
    this.pnpc.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    ...
    this.pnpc.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(1680, 7758, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc.create(3535, 5959, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    //group 2//
    this.pnpc2 = this.physics.add.group();
    this.pnpc2.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    ...
    this.pnpc2.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc2.create(2014, 7567, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    //group 3//
    this.pnpc3 = this.physics.add.group();
    this.pnpc3.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(area1X, area1Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    ...
    this.pnpc3.create(area2X, area2Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(area3X, area3Y, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(2738, 7097, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(3516, 6535, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.pnpc3.create(3505, 5999, "fpNPC").play("fpNPC").setScale(elaineScale).setSize(npcSizeX, npcSizeY).setOffset(npcOffsetX, npcOffsetY);
    this.npcMove();
    this.timedEvent = this.time.addEvent({delay: 12000, callback: this.npcMove, callbackScope: this, loop: true});
    this.npcMove2();
    this.timedEvent = this.time.addEvent({delay: 6000, callback: this.npcMove2, callbackScope: this, loop: true});
    this.npcMove3();
    this.timedEvent = this.time.addEvent({delay: 24000, callback: this.npcMove3, callbackScope: this, loop: true});
    //
    ...
    //NPCs' collision
    this.pnpc.children.iterate((npc) => {npc.setCollideWorldBounds(true);});
    ...
    this.physics.add.overlap(this.player, this.pnpc, this.nextScene, null, this);
    this.physics.add.overlap(this.player, this.pnpc2, this.nextScene2, null, this);
    this.physics.add.overlap(this.player, this.pnpc3, this.nextScene3, null, this);
    //
    //not yet//
    //score
    ...
    this.cameras.main.setBounds(0, 0, map.widthInPixels + 6848, map.heightInPixels + 6848);
