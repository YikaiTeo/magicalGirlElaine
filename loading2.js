...
class loading2 extends Phaser.Scene {
  ...
  create() {
    ...
    this.player = this.add.sprite(850, 550, "Elaine").play("right").setScale(0.2);
    this.monster = this.add.sprite(750, 550, "Monster").play("Monster").setScale(0.2);
  ...
  update() {
    ...
    if (x > 490) {
      ...
      this.scene.start("room", {player : this.playerPosition});
    }
  }
}