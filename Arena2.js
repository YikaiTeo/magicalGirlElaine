...
class arena2 extends Phaser.Scene {
  constructor() {
    super({ key: "arena2" });
  }
  ...
  preload() {
    ...
    //tilemap preload//
    //arena//
    this.load.tilemapTiledJSON("arena2Map", "assets/Arena2.json");
    ...
    this.load.audio("hurt", [
      "assets/music/smartsound_WEAPONS_BULLET_Small_Impact_Body_03.mp3"
    ]);
    this.load.audio("attack1", [
      "assets/music/zapsplat_fantasy_magic_spell_zap_whoosh_impact_dark_airy_001_26095.mp3"
    ]);
    this.load.audio("attack2", [
      "assets/music/zapsplat_magic_wand_zap_spark_power_001_12551.mp3"
    ]);
  }
  ...
  create() {
    ...
    this.Attack1 = this.sound.add("attack1");
    this.Attack2 = this.sound.add("attack2");
    this.music.play();
    this.music.setVolume(0.5).setLoop(true);
    //
    //create layers//
    var map = this.make.tilemap({ key: "arena2Map" });
    //map variables//
