...
class arena extends Phaser.Scene {
  ...
  create() {
    ...
    //player//
    var elaineScale = 0.2;
    this.player = this.physics.add.sprite(800, 820, "elaine").setScale(elaineScale).setSize(250, 370);
    //monster//
    this.monsters1 = this.physics.add.sprite(1000, 800, "monster").play("Monster").setVisible(true).setScale(elaineScale);
    monster1Downed = false;
    this.monsters2 = this.physics.add.sprite(1000, 220, "monster").play("Monster").setVisible(true).setScale(elaineScale);
    monster2Downed = false;
    this.monsters3 = this.physics.add.sprite(350, 500, "monster").play("Monster").setVisible(true).setScale(elaineScale);
    monster3Downed = false;
    this.monsters4 = this.physics.add.sprite(500, 800, "monster").play("Monster").setVisible(true).setScale(elaineScale);
    monster4Downed = false;
    this.monsters5 = this.physics.add.sprite(700, 900, "monster").play("Monster").setVisible(true).setScale(elaineScale);
    monster5Downed = false;
    //
    //overlaying layer//
    this.wallsOverlayLayer = map.createLayer("wallsOverlay", WallsOverlay, 250, 130).setScale(1);
    //
    //magic circle and lightning//
    this.circle = this.physics.add.sprite(0, 0, "circle").play("circle").setScale(elaineScale).setVisible(false);
    this.lightning = this.physics.add.sprite(-1, 45, "lightning").play("lightning").setScale(elaineScale).setVisible(false).setSize(300, 470).setOffset(156, 250);
    //
        ...
        function () {
          ...
          this.time.delayedCall(
            ...
            function () {
              ...
              this.lightning.setPosition(-1, 45);
            },
            [],
            this
          );
