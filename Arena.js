...
class arena extends Phaser.Scene {
  ...
  create() {
    ...
    this.circle = this.physics.add.sprite(-100, 0, "circle").play("circle").setScale(elaineScale).setVisible(false);
    this.lightning = this.physics.add.sprite(-101, 45, "lightning").play("lightning").setScale(elaineScale).setVisible(false).setSize(300, 470).setOffset(156, 250);
    //
    ...
    if (
      ...
      this.time.delayedCall(
        ...
        function () {
          ...
          this.scene.start("city", {player : this.playerPosition});
        }, [], this
      );
    }
  }
