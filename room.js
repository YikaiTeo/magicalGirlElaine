class room extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      "floor",
      "assets/Pipoya_RPG_Tileset_16x16/[Base]BaseChip_pipo.png",
      {
        frameWidth: 64,
        frameHeight: 64
      }
  ...
  create() {
    ...
    var FurnitureExtra = map.addTilesetImage(
      "[Base]BaseChip_pipo",
      "furnitureExtra"
    );
    var FurnitureOverlay = map.addTilesetImage(
      "[Base]BaseChip_pipo",
      "furnitureOverlay"
    );
    ...
    this.cameras.main.setBounds(
      0,
      0,
      map.widthInPixels + 1008,
      map.heightInPixels + 1120
    );
  ...
  update() {
    ...
    if (
      ...
      this.scene.start("city", { player: this.playerPosition, music: this.music });
    }
  }
}