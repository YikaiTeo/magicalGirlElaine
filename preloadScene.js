  ...
  create() {
    this.add
      .text(
        800,
        500,
        "press 'command' + 'minus sign(-)' to zoom out if game screen is too big",
        { font: "25px Courier", fill: "#FFFFFF" }
      )
      .setOrigin(0.5);
    this.add
      .text(800, 600, "use 'ctrl' + 'minus sign(-)' to zoom out for windows", {
        font: "25px Courier",
        fill: "#FFFFFF"
      })
      .setOrigin(0.5);
    ...
    this.magiccircle = this.add
      .image(300, 550, "magicCircle")
      .setScale(0.24)
      .setVisible(false);
    //main stuff//
    this.main = this.add
      .image(800, 600, "Elaine")
      .setScale(0.24)
      .setVisible(false);
    //press spacebar word//
    this.start = this.add
